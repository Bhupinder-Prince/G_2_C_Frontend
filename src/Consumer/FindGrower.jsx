...
function FindGrower(){
    ...
    async function doUpdateCity()
    {
      ...
      const url = `${baseURL}/growerProfile/fetch-city`;  
    ...
    async function doFindGrower()
    {
      ...
      const url = `${baseURL}/gowerProfile/find-grower`;  
      // alert(JSON.stringify(obj));
        ...
        <>
          ...
          <div className="border-b border-gray-900/10 pb-4">
              <img
                  ...
                  alt="Your Company"
                />
              <h2 className="text-base text-lg font-semibold leading-7 text-gray-900">Find Grower</h2>
              
            </div>
            {showFindGrowerPg ? 
            <div className="grid gap-6 mb-6 mt-8 md:grid-cols-1">
              <div>
                  ...
                  <select id="category" name="category" onChange={doUpdate} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-100 block w-full p-2.5 dark:bg-gray-100 dark:border-gray-100 dark:text-black dark:focus:ring-green-300 dark:focus:border-green-500" placeholder="" required>
                    ...
                    <option value="Dairy Products">Milk Products</option>
              ...
              <div>
                <label htmlFor="product" className="block mb-2 text-base font-serif font-medium text-gray-900">Products</label>
                    <select name="product" id="product" onChange={doUpdate2} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-100 block w-full p-2.5 dark:bg-gray-100 dark:border-gray-100 dark:text-black dark:focus:ring-green-300 dark:focus:border-green-500" placeholder="" required>    
              ...
              <div>
                <label htmlFor="city" className="block mb-2 text-base font-serif font-medium text-gray-900">City</label>
                    <select name="city" id="city" onChange={doUpdate} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-100 block w-full p-2.5 dark:bg-gray-100 dark:border-gray-100 dark:text-black dark:focus:ring-green-300 dark:focus:border-green-500" placeholder="" required>    
              ...
              <button type="button" onClick={doFindGrower} className="ml-[600px] mb-[30px] w-[150px] mt-3 text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-2 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Search&nbsp;Grower</button>
            </div> 
            : null }
            {/* ==============GROWERS AVAILABLE==================== */}
                  ...
                  return (
                    <div key={index} className="max-w-sm w-[350px] mb-10 h-[400px] ml-[100px] mt-10 border border-gray-200 rounded-lg shadow dark:bg-green-100 dark:border-gray-700"> 
                      <div className="p-2">
                          ...
                          <button type="button" className="w-[140px] mt-3 ml-[90px] px-3 py-2 text-sm font-medium text-center text-white bg-green-700 rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                            Contact&nbsp;Grower
                          </button>
                      </div>
                    </div>
